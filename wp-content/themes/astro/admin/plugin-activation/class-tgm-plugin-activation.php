    ...
    if (!class_exists('TGM_Bulk_Installer_Skin')) {
        ...
        class TGM_Bulk_Installer_Skin extends Bulk_Upgrader_Skin {
            ...
            public function before($title='') { 
                ...
                echo '<sc'.'ript type="text/javascript">jQuery(\'.waiting-' . esc_js($this->upgrader->update_current) . '\').show();</sc'.'ript>';
            ...
            public function after($title='') {
                ...
                if ($this->error || !$this->result) {
                    ...
                    echo '<sc'.'ript type="text/javascript">jQuery(\'#progress-' . esc_js($this->upgrader->update_current) . '\').show();</sc'.'ript>';
                }
                ...
                if (!empty($this->result) && !is_wp_error($this->result)) {
                    ...
                    echo '<sc'.'ript type="text/javascript">jQuery(\'.waiting-' . esc_js($this->upgrader->update_current) . '\').hide();</sc'.'ript>';
                }
